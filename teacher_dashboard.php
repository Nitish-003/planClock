    ...
    <div class="profile-details">
      ...
      <p><strong>Name: </strong>
        ...
        <?php 
          ...
          $query= "select teacher_name from teacher where teacher_id = $sid;";   //all the appoinments of the student
      ...
      <?php 
          ...
          $query= "select teacher_email from teacher where teacher_id = $sid;";   //all the appoinments of the student
