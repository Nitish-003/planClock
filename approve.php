...
<?php 
    ...
    $a_id=$_GET['a_id'];
    $status = $_GET['status'];
    $_SESSION['appoint_id']= $a_id;

    $query = "update appoinment_table set status= 'Confirmed' where appoinment_id=$a_id";
    ...
    $_SESSION['recipient_name'] = $name;
        ...
        try {
            ...
            $mail->Subject = 'PlanClock- Appointment Confirmed';
            $mail->Body    = "Dear $name, <br><br>We hope this email finds you well. <br> We wish to inform you that your appointment has been Confirmed with $sidi. Kindly be in venue on time. <br><br> Regards, <br> PlanClock ";
