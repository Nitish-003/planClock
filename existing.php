...
<div class="container-fluid position-relative p-0">
  <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto py-0">
        ...
        <a href="existing.php" class="nav-item nav-link active" >Existing Appointment</a>
  ...
  <!-- Navbar  End -->
  <div class="headline">
    <center><h2 class="tab-space"> <b> Manage Booking </b> </h2></center>
    <br><br>
  </div>
      ...
      <table>
        <tr>
          ...
          <?php 
              ...
              $query= "select * from appoinment_table where student_id = $sidi;";   //all the appoinments of the student
